...
for %%i in (%tremoval%) do (
    ...
    gams FAIR.gms --initial_conditions=historical_run --experiment=pulse --gas=co2 --tremoval=%%i --srm=1
    gams FAIR.gms --initial_conditions=historical_run --experiment=pulse --gas=co2 --tremoval=%%i 
)
