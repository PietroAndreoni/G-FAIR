...
set "gas=co2 ch4 n2o"
set "rcp=RCP3PD RCP45 RCP60 RCP85"
set "cool=5 10 20 40"
set "timepulse=5 20 50"
...
for %%a in (%gas%) do (
    for %%c in (%rcp%) do (
        for %%d in (%timepulse%) do (
            ...
            gams FAIR.gms --initial_conditions=historical_run --experiment=srmpulse --gas=%%a --rcp=%%c --pulse_time=%%d --srm=1
            ...
            for %%b in (%cool%) do (
                for %%e in (%stop%) do (
                    ...
                    gams FAIR.gms --initial_conditions=historical_run --experiment=srmpulse --gas=%%a --cooling_rate=%%b --start_rampdown=%%e --end_rampdown=!f! --rcp=%%c --pulse_time=%%d --srm=1 --srm_exogenous=1
