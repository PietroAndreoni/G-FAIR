...
TSLOW_GHG.fx(tfirst) = tslow0;
TFAST_GHG.fx(tfirst) = tfast0;
...
TSLOW_GHG.fx(tfirst) = TSLOW_GHG.l('255');
TFAST_GHG.fx(tfirst) = TFAST_GHG.l('255');
...
FORC_SRM.fx(tfirst) = FORC_SRM.l('255');
