...
input_axis_labels <- c("ecs"="plain(ECS)",
                       "tcr"="plain(TCR)",
                       "rcp"="plain(RCP)",
                       "pulse_time"="plain(yr)[pulse]",
                       "geo_start"="plain(SAI)[start]",
                       "geo_end"="plain(SAI)[end]",
                       "cool_rate"="plain(SAI)[rate]",
                       "alpha"="alpha",
                       "delta"="delta",
                       "theta"="theta",
                       "prob"="plain(p)",
                       "dg"="plain(g)",
                       "term"="plain(yr)[term]",
                       "mortality_ozone"="mu[O[3]]",
                       "vsl"="plain(VSL)",
                       "vsl_eta"="eta[plain(VSL)]",
                       "mortality_srm"="mu[plain(SAI)]",
