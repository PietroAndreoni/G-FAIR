...
$ifthen.m set methane_emissions
W_EMI.fx('ch4',t)$(t.val eq %pulse_time%) = W_EMI.l('ch4',t) + %CO2toCH4_pulse% * %pulse_size%/100 * (emissions_rcp('2005','%rcp%','co2')/CO2toC) * 16/44 * 1e3 ;
W_EMI.fx('ch4',t)$(t.val gt %pulse_time% and t.val lt %pulse_time%  + %proj_duration%) = W_EMI.l('ch4',t) + %CO2toCH4_long% * %pulse_size%/100 * (emissions_rcp('2005','%rcp%','co2')/CO2toC) * 16/44 * 1e3;

* methane emissions from wetlands are biogenic
FF_CH4.fx(t)$(t.val eq %pulse_time%) = 1 - ((1-FF_CH4.l(t)) * emi_prepulse('ch4',t) + %CO2toCH4_pulse% * %pulse_size%/100 * (emissions_rcp('2005','%rcp%','co2')/CO2toC) * 16/44 * 1e3 ) / W_EMI.l('ch4',t);
FF_CH4.fx(t)$(t.val gt %pulse_time% and t.val lt %pulse_time% + %proj_duration%) = 1 - ((1-FF_CH4.l(t)) * emi_prepulse('ch4',t) + %CO2toCH4_long% * %pulse_size%/100 * (emissions_rcp('2005','%rcp%','co2')/CO2toC) * 16/44 * 1e3 ) / W_EMI.l('ch4',t);
$endif.m
